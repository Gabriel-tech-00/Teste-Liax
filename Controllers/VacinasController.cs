...
namespace Gerenciamento_Empresas.Controllers
{
    public class VacinasController : Controller
    {
        ...
        {
            return View(await _context.Vacina.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Data")] Vacina vacina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Data")] Vacina vacina)
        {
            if (id != vacina.Id)
            {
                return NotFound();
