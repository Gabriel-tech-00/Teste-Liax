...
namespace Gerenciamento_Empresas.Controllers
{
    public class CidadesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EstadoId,Nome")] Cidade cidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EstadoId,Nome")] Cidade cidade)
        {
            if (id != cidade.Id)
            {
                return NotFound();
